...
class DebugValue {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('array_id')) {
        this.array_id = initObj.array_id
      }
      else {
        this.array_id = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [array_id]
    bufferOffset = _serializer.int32(obj.array_id, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [array_id]
    data.array_id = _deserializer.int32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.array_id !== undefined) {
      resolved.array_id = msg.array_id;
    }
    else {
      resolved.array_id = 0
    }
